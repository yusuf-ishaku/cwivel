...
export const Navbar = (props) => {
    return(
        <div className="w-full bg-cwivel-green px-4 md:px-14 flex py-4 flex-row justify-between items-center">
            <div className=" text-white m-1 px-6 text-xs sm:text-lg p-2">
                <h1 className="text-white sm:text-xl inline text-lg">Cwivel</h1>
                <span className="text-teal-600 inline">.com</span>
            </div>
